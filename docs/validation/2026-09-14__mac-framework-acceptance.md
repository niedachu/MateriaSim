...
迁移说明（2026-09-15）：本记录从 `materials_simulation/docs/2026-09-14__mac-framework-acceptance.md` 移至 `docs/validation/`。正文的运行命令、包名、阶段完成范围与绝对证据路径是当时的历史事实；当前入口以根 README 为准。只修正相对文档链接，不改写 Run。
