...
| [插件化研究 Harness](2026-09-17__harness__plugin-research-automation__architecture-plan.md)（2026-09-17 新增，无迁移来源） | materiasim.plan.harness.plugin_research_automation | H0/H1 完成，H2 本地限定故障矩阵通过；2026-09-18 增补 H3 本地协议和脚本 provider 验收，真实模型／宿主隔离及部署级重启／断电仍待验；知识提取至平台能力／配置关系及 Harness／agent 指南；无位置迁移，不替代材料／B/C／服务器计划 |
