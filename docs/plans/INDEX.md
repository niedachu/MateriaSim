...
状态以每份计划的 frontmatter 和最新范围说明为准，本表不重复维护状态账本。

| 主线 | 规范计划 | 范围 |
|---|---|---|
| 长期材料蓝图 | [最初升级](2026-09-14__multicomponent-simulation__upgrade-plan.md) | 保留历史；具体材料实施转交下一行 |
| 材料覆盖 | [多组分多场景](2026-09-14__multicomponent-multiscenario__implementation-plan.md) | M1—M6；已有小分子子集不等于所有材料 |
| 执行资源 | [CPU/GPU](2026-09-14__execution__cpu-gpu-runtime__implementation-plan.md) | 部分被框架实现覆盖；服务器验收仍缺 |
| 包与研究组织 | [基础组件与研究包](2026-09-15__architecture__simulation-package-and-research-bundles__implementation-plan.md) | 保留 A—D 与后续覆盖关系 |
