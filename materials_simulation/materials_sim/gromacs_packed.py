...
from .assembly import collect_models
from .files import content_hash, sha256, write_json
from .gromacs import command
from .gromacs_stage import compile_stage
from .packmol import pack
from .prebuilt import declared_counts, verify_processed_models
from .topology import atom_mapping
...
def prepare_packed(root, spec, sources, engine, attempt, candidate):
    ...
    from .gromacs_build import snapshot
