...
def pack(spec, models, built, attempt, candidate):
    """Run one bounded fixed-seed packing attempt and save checked coordinates/instance provenance."""
    ...
    outcome = command(info, ["-i", "packing.inp"], folder, attempt / "packmol", folder, seconds=60)
    ...
    write_gro(built / "boxed.gro", atoms, box)
