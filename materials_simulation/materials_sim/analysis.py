...
from .config_v2 import analysis_requests
from .files import content_hash, read_json, sha256, utc_now, write_json
from .hydration import hydration_contacts
from .component_contacts import component_contacts
from .records import stage_artifact, stage_ids
from .state import source_identity, verify_run
...
def analyze(run, output_root, request=None):
    ...
    for protected in (root, source_root):
