...
from materials_sim.analysis import analyze, selected_requests
from materials_sim.config_v2 import analysis_requests
from materials_sim.files import content_hash, read_json, write_json
from materials_sim.gromacs_stage import assess_stage
from materials_sim.protocol import mdp_values, stage_values, validate_stages
from materials_sim.records import stage_ids
from materials_sim.schema import load_spec
from materials_sim.state import verify_execution, verify_run
from verify_m1_evidence import compare_effective
...
class ContractTests(unittest.TestCase):
    ...
    def test_repeated_types_and_renamed_ids(self):
        ...
        validate_stages(self.stages, self.sources)
    ...
    def test_wrong_handoff(self):
        ...
        for field, value in (("stage_id", "em"), ("kind", "coordinates")):
            ...
            with self.subTest(field=field), self.assertRaises(ValueError):
                validate_stages(stages, self.sources)
    ...
    def test_nonzero_time_and_step_origins(self):
        ...
        with patch("materials_sim.gromacs_stage.checkpoint", return_value=dict(step=200, time_ps=10.4, atom_count=10)):
        ...
        with patch("materials_sim.gromacs_stage.checkpoint", return_value=dict(step=200, time_ps=.4, atom_count=10)):
