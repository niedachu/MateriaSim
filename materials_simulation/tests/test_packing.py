...
from materials_sim.assembly import collect_models, merge_types, validate_packing
from materials_sim.component_contacts import molecule_pairs
from materials_sim.files import read_json
from materials_sim.packmol import check_periodic_clashes, ordered_instances, packmol_info, pdb_template, read_packed
...
class PackingTests(unittest.TestCase):
    ...
    def test_packmol_requires_file_input_interface(self):
        ...
        with patch("materials_sim.packmol.shutil.which", return_value="/usr/bin/true"), \
             patch("materials_sim.packmol.subprocess.run", return_value=SimpleNamespace(stdout="Version 20.15.0",stderr="")):
