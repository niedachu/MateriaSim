...
from materials_sim.config_v2 import interaction_bundle, resolve_components
from materials_sim.files import read_json, write_json
from materials_sim.prebuilt import declared_counts, molecular_definitions, validate_prebuilt_sources, verify_processed_models
...
class PrebuiltTests(unittest.TestCase):
    ...
    def test_incomplete_bundle_rejected(self):
        ...
        bundle = read_json(EXAMPLES / "cat_ani_bundle.json")
